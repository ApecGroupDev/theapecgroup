    ...
    <footer className='text-black font-inter scrn-750:px-8 scrn-450:pt-24 scrn-600:pt-20 scrn-750:pt-8 scrn-800:pt-12 scrn-1250:pt-24 scrn-1500:pt-28 scrn-1700:pt-36 scrn-1700:px-20 scrn-1900:pt-48 scrn-1900:px-24 scrn-2500:px-32'>
      <div className='grid grid-cols-3 gap-8 items-center text-gray-300'>
        ...
        <div className='flex flex-col ms-2 scrn-600:ms-4 scrn-600:mt-8 scrn-750:mt-0 scrn-750:ms-0 items-start space-y-2 scrn-750:space-y-1 scrn-1000:space-y-2'>
          <span className='text-xs scrn-750:pt-6 scrn-1250:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg text-gray-700 whitespace-nowrap'>For More Information</span>
          <span className='text-xs scrn-750:ps-0 scrn-1000:ps-6 scrn-125:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg whitespace-nowrap text-gray-700'><a href="tel:855-444-2732">855-444-2732</a> | <a href="mailto:Sales@TheAPECgroup.com">Sales@TheAPECgroup.com</a></span>
        ...
        <div className='flex flex-col space-y-4 pb-4 items-center scrn-750:pt-2'>
          <p className='hidden scrn-750:block scrn-750:text-xs scrn-1250:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg scrn-2500:text-xl leading-relaxed text-gray-700'>
          ...
          <p className='hidden scrn-750:hidden scrn-1000:block scrn-750:text-xs scrn-1250:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg scrn-2500:text-xl leading-relaxed'>
            <span className='text-gray-700'>For More Info:</span> <a href="tel:855-444-2732"><span className='text-gray-700'>855-444-2732</span></a><br />
            <a
      ...
      <div className='w-full py-4'>
        <p className='text-xs scrn-1250:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg scrn-2500:text-xl text-center text-gray-700 font-light'>
