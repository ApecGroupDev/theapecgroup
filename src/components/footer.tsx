...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 md:pt-4 lg:pt-6 xl:pt-14 mac-14:pt-28 mac-16:pt-52 mac-16:px-20">
      <div className="grid md:grid-cols-3 gap-8 items-center text-gray-300">
        ...
        <div className="flex flex-col items-center md:items-start md:space-y-1 lg:space-y-2">
          <span className="md:text-xs md:pt-6 xl:text-sm mac-14:text-base mac-16:text-lg">For More Information</span>
          <span className='md:ps-0 lg:ps-6 md:text-xs xl:text-sm mac-14:text-base mac-16:text-lg whitespace-nowrap'>855-444-APEC | Sales@TheAPECgroup.com</span>
        ...
        <div className="flex flex-col space-y-4 pb-4 items-center md:pt-2">
          <p className="md:text-xs xl:text-sm mac-14:text-base mac-16:text-lg leading-relaxed">
          ...
          <p className="md:max-lg:hidden md:text-xs xl:text-sm mac-14:text-base mac-16:text-lg leading-relaxed">
        ...
        <div className="flex justify-end">
          <Link href="/">
            <img
              ...
              alt="APEC Logo"
              className="transition-transform duration-300 ease-in-out transform hover:scale-105 md:h-28 lg:h-40 xl:h-52 mac-14:h-60 mac-16:h-72"
            />
          </Link>
        </div>
      </div>
      ...
      <div className="w-full py-4">
        <p className="md:text-xs  xl:text-sm mac-14:text-base mac-16:text-lg text-center text-gray-300 font-light">
