  ...
  return (
    <div className="bg-transparent md:px-12">
      <div className="text-center">
        <h2 className="text-4xl md:text-3xl w-900:text-5xl lg:text-5xl xl:text-6xl mac-14:text-7xl 2xl:text-6xl 2k:text-8xl font-extrabold text-gray-800 tracking-tight leading-tight">
          <span className="text-red-600">Proud</span> Member Of
        </h2>
        <p className="md:text-sm w-900:text-base xl:text-lg mac-14:text-xl text-gray-500 mt-2 max-w-2xl mac-14:max-w-full mx-auto">
      ...
      <Swiper
        ...
        className="mySwiper mac-14:mt-16"
      >
          ...
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center p-4 transition-transform duration-300 ease-in-out hover:scale-110">
              <img
                src={association.src}
                alt={association.alt}
                className="md:h-40 xl:h-60 lg:h-48 mac-14:h-64 2k:h-96 max-w-full object-contain mb-4"
              />
