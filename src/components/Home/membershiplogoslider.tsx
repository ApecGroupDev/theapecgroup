...
const MembershipLogosCarousel: React.FC = () => {
  return (
    <section className="bg-transparent pb-96 lg:mt-60 lg:px-16 xl:mt-72 xl:px-24 mac-14:mt-80 mac-14:px-48 2xl:mt-96 2xl:px-60 2k:mt-128">
          ...
          <SwiperSlide key={index}>
            <div className="flex flex-col items-center p-4 transition-transform duration-300 ease-in-out hover:scale-110">
              <img
                src={association.src}
                alt={association.alt}
                className="xl:h-60 lg:h-48 max-w-full object-contain mb-4"
              />
