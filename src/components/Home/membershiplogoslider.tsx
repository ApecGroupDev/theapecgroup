...
const MembershipLogosCarousel: React.FC = () => {
  return (
    <section className="bg-transparent pb-96 md:px-20 md:mt-32 lg:mt-60 lg:px-16 xl:mt-80 xl:px-24 mac-14:mt-144 mac-14:px-48 2xl:mt-128 2xl:px-60 2k:mt-160">
