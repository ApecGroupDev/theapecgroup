...
const Hero: React.FC = () => {
  return (
    <div className="relative flex flex-col-reverse md:flex-row items-center justify-between bg-transparent px-8 md:px-16 2xl:pt-16 lg:pt-0 lg:px-16 xl:px-28 2k:px-40">
      {/* Left Text Section */}
      <div className="text-center md:text-left 2xl:mb-20 text-black md:mt-8 lg:mt-16 xl:mt-0 2k:mt-16">
      ...
      {/* Right Image Section */}
      <div className="w-full md:w-1/2 flex justify-center mb-8 md:mt-32 lg:mt-40 mac-14:mt-12 xl:mt-16 2k:mt-12">
        <img
          src="/products/Pump.png"
          alt="Hero"
          className="rounded-lg object-cover w-full max-w-[500px] md:max-w-[250px] lg:max-w-[400px] xl:max-w-[600px] xl:mt-12 mac-14:max-w-[540px] 2xl:max-w-[700px] 2k:max-w-[900px]"
        />
      </div>
    </div>
  );
