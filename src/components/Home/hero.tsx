...
const Hero: React.FC = () => {
  return (
    <div className="relative flex flex-col-reverse md:flex-row items-center justify-between bg-transparent px-8 md:px-16 2xl:pt-16 lg:pt-0 lg:px-16 xl:px-28 2k:px-40">
      {/* Left Text Section */}
      <div className="text-center md:text-left 2xl:mb-20 text-black md:mt-8 lg:mt-12 xl:mt-0 2k:mt-16">
      ...
      {/* Right Image Section */}
      <div className="w-full md:w-1/2 flex justify-center mb-8 md:mt-32 lg:mt-24 xl:mt-0 2k:mt-12">
        <img
