...
const Hero: React.FC = () => {
  return (
    <div className="relative flex flex-col-reverse md:flex-row items-center justify-between min-h-screen bg-transparent px-8 md:px-16 md:pt-16 lg:px-40 xl:px-28 macbook-pro-16:pb-28 2k:px-40">
      {/* Left Text Section */}
