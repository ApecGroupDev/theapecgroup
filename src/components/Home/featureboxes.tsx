...
const FeatureBoxes: React.FC = () => {
  return (
    <section className="md:mt-24 md:px-28 w-800:mt-16 w-900:mt-24 lg:mt-8 lg:px-32 xl:mt-16 xl:px-36 mac-14:mt-40 mac-14:px-32 mac-16:px-42 2xl:mt-24 2xl:px-60 2k:mt-52 2k:px-42">
      {/* Section Title */}
