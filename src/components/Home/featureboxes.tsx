...
const features: FeatureBox[] = [
  {
    ...
    icon: <FaUsers className="text-5xl lg:text-4xl text-red-600" />,
  },
  {
    title: "EXECUTION",
    description: "“You can’t build a reputation on what you are going to do” – Henry Ford.",
    icon: <FaTasks className="text-5xl lg:text-4xl text-red-600" />,
  },
  {
    title: "CUSTOMER",
    description: "“Get closer than ever to your customers.” – Steve Jobs.",
    icon: <FaHandshake className="text-5xl lg:text-4xl text-red-600" />,
  },
  {
    title: "EXPERIENCE",
    description: "“Experience is the teacher of all things” – Julius Caesar.",
    icon: <FaChartLine className="text-5xl lg:text-4xl text-red-600" />,
  },
  {
    title: "SERVICE",
    description: "“Great customer service means honoring the customer” – Chris LoCurto.",
    icon: <FaCogs className="text-5xl lg:text-4xl text-red-600" />,
  },
];

const FeatureBoxes: React.FC = () => {
  return (
    <section className="lg:mt-8 lg:px-32 xl:mt-16 xl:px-36 mac-14:mt-24 mac-14:px-32 mac-16:px-42 2xl:mt-24 2xl:px-60 2k:mt-52 2k:px-42">
      {/* Section Title */}
      <div className="text-center">
        <p className="text-7xl lg:text-5xl xl:text-6xl 2k:text-8xl font-extrabold text-gray-800 mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-12 gap-8 lg:mt-8 xl:mt-14 mac-14:mt-16 mac-14:gap-16 mac-16:gap-24 2xl:gap-40 2xl:mt-24">
        ...
        {features.slice(0, 3).map((feature, index) => (
          <div
            key={index}
            className="relative mx-auto group bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-xl hover:bg-white transition-all lg:w-10/12 xl:w-10/12 mac-14:w-11/12 2xl:w-11/12 duration-500"
          >
            <div className="flex flex-col items-center justify-center h-40 lg:h-32 xl:h-48 mac-14:h-60 2xl:h-64 2k:h-96">
              {feature.icon}
              <h3 className="text-2xl lg:text-xl font-bold text-center mt-4 text-gray-800">{feature.title}</h3>
            </div>
