...
const FeatureBoxes: React.FC = () => {
  return (
    <section className="md:mt-24 md:px-28 w-800:mt-16 w-900:mt-40 w-900:px-12 lg:px-24 xl:mt-60 xl:px-36 mac-14:mt-12 mac-14:px-32 mac-16:px-42 2xl:mt-24 2xl:px-60 2k:mt-52 2k:px-42">
      {/* Section Title */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-12 gap-8 md:mt-16 w-900:mt-12 lg:mt-12 xl:mt-12 mac-14:mt-16 mac-14:gap-16 mac-16:gap-24 2xl:gap-40 2xl:mt-24">
        ...
        {features.slice(0, 3).map((feature, index) => (
          ...
          >
            <div className="flex flex-col items-center justify-center h-40 md:h-20 w-900:h-40 lg:h-40 xl:h-48 mac-14:h-60 2xl:h-64 2k:h-96">
              {feature.icon}
