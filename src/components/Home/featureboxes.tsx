  ...
  return (
    <div className="bg-transparent md:px-12 w-900:px-20">
      ...
      <div className="text-center">
        <p className="md:text-5xl w-900:text-5xl lg:text-5xl xl:text-6xl mac-14:text-7xl mac-16:text-7xl 2xl:text-8xl 2k:text-9xl font-extrabold text-gray-800 mb-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-12 gap-8 mac-16:mt-12 2xl:mt-16">
        ...
        {features.slice(0, 3).map((feature, index) => (
          ...
          >
            <div className="flex flex-col items-center justify-center md:h-24 w-900:h-28 lg:h-40 xl:h-52 mac-14:h-60 mac-16:h-72 2xl:h-80 2k:h-96">
              {feature.icon}
        ...
        <div className="flex flex-wrap justify-center gap-14 col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-3 xl:gap-24 mac-14:gap-32 mac-16:gap-24 2xl:col-span-3 2xl:gap-44 2k:mt-24">
          {features.slice(3).map((feature, index) => (
            ...
            >
              <div className="flex flex-col items-center justify-center md:h-24 w-900:h-32 lg:h-40 xl:h-52 mac-14:h-60 mac-16:h-72 2xl:h-80 2k:h-96">
                {feature.icon}
