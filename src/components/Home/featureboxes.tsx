  ...
  return (
    <div className="bg-transparent md:px-24">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:gap-12 gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-14 col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-3 xl:gap-24 mac-14:gap-32 mac-16:gap-36 2xl:col-span-3 2xl:gap-44">
