const About: React.FC = () => {
  return (
    <div className="relative w-full bg-transparent flex flex-col md:flex-row justify-center lg:px-8 xl:px-28 lg:mt-32 xl:mt-32 mac-14:mt-0 mac-16:mt-0 2xl:mt-28">
      {/* Left Image Section */}
      ...
      {/* Right Text Section */}
      <div className="w-full md:w-3/5 p-6 md:p-12 2xl:px-24 lg:mt-20 2xl:mt-8 2k:px-28 mac-14:pt-12 mac-16:pt-8 flex flex-col">
        ...
        <p className="mt-6 lg:text-md xl:text-md mac-14:text-xl 2xl:text-xl 2k:text-2xl text-gray-600 tracking-wider">
        ...
        <p className="mt-4 lg:text-md xl:text-md mac-14:text-xl 2xl:text-xl 2k:text-2xl text-gray-600 tracking-wider">
