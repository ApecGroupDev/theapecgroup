const About: React.FC = () => {
  return (
    <div className="relative w-full bg-transparent flex flex-col md:flex-row justify-center md:px-8 lg:px-8 xl:px-28 w-800:mt-12 lg:mt-0 xl:mt-8 mac-14:mt-0 mac-16:mt-0 2xl:mt-28">
      {/* Left Image Section */}
