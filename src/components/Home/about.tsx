const About: React.FC = () => {
  return (
    <div className="relative w-full bg-transparent flex flex-col md:flex-row justify-center md:px-8 md:mt-24 lg:px-8 lg:mt-32 xl:px-28 w-800:mt-12 xl:mt-24 mac-14:mt-0 mac-16:mt-0 2xl:mt-28">
      {/* Left Image Section */}
      <div className="w-full md:w-2/5 flex justify-center md:py-8 lg:py-32 lg:p-12 mac-14:pt-0 mac-16:px-14 2xl:pt-0">
        <img
      ...
      <div className="w-full md:w-3/5 p-6 md:p-4 lg:p-12 mac-14:pt-12 mac-16:pt-8 xl:mt-0 2xl:px-24 2xl:mt-8 2k:px-28 flex flex-col">
        ...
        <p className="mt-6 md:text-xs lg:text-lg xl:text-lg mac-14:text-xl 2xl:text-xl 2k:text-2xl text-gray-600 tracking-wider">
        ...
        <p className="mt-4 md:text-xs lg:text-lg xl:text-lg mac-14:text-xl 2xl:text-xl 2k:text-2xl text-gray-600 tracking-wider">
