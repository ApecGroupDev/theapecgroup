    ...
    <div className="w-full bg-transparent flex flex-col md:flex-row md:px-12">
      ...
      <div className="w-full md:w-2/5">
        <img
          ...
          alt="Hero"
          className="rounded-lg object-cover max-w-full lg:w-11/12"
        />
      </div>

      {/* Right Text Section */}
      <div className="md:w-3/5 flex flex-col">
        <p className="md:text-4xl mac-14:text-6xl 2xl:text-6xl 2k:text-8xl font-semibold italic">Welcome to</p>
        <p className="md:text-5xl mac-14:text-6xl 2xl:text-6xl 2k:text-8xl font-extrabold text-red-600">APEC</p>
