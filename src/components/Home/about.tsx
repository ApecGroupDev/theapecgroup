  ...
  return (
    <div className="w-full bg-transparent flex flex-col md:flex-row md:px-12">
      ...
      <div className="md:w-3/5 flex flex-col">
        <p className="md:text-4xl lg:text-3xl mac-14:text-6xl 2xl:text-6xl 2k:text-8xl font-semibold italic">Welcome to</p>
        <p className="md:text-5xl lg:text-2xl mac-14:text-6xl 2xl:text-6xl 2k:text-8xl font-extrabold text-red-600">APEC</p>
        ...
        <p className="mt-4 md:text-sm w-900:text-base lg:text-lg xl:text-lg mac-14:text-xl 2xl:text-xl 2k:text-2xl text-gray-800">
