const About: React.FC = () => {
  return (
    <div className="relative w-full bg-transparent flex flex-col md:flex-row justify-center xl:px-28 2xl:mt-28">
      {/* Left Image Section */}
      <div className="w-full md:w-2/5 flex justify-center items-center p-6 md:p-12">
        <img
          src="/products/station.jpg"
          alt="Hero"
          className="rounded-lg object-cover w-full max-w-[400px] md:max-w-[500px] lg:max-w-[450px]"
        />
      </div>

      {/* Right Text Section */}
      <div className="w-full md:w-3/5 p-6 md:p-12 2xl:px-24 flex flex-col">
        <p className="text-5xl md:text-6xl font-bold tracking-wider italic">Welcome to</p>
        ...
        <p className="mt-6 text-lg md:text-xl text-gray-600 tracking-wider">
        ...
        <p className="mt-4 text-lg md:text-xl text-gray-600 tracking-wider">
