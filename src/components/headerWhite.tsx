            ...
            label === "SERVICES" ? (
              ...
              >
                <div className="relative flex items-center gap-1">
                  <Link
                    href={path}
                    className={`capitalize scrn-750:text-xs scrn-1000:text-base text-white hover:text-[#c62931] transition-colors duration-200 relative flex items-center gap-1 ${pathname.startsWith(path) ? "text-red-800" : ""
                      }`}
                  >
                    {label}
                    <ChevronDown
              ...
              <Link
                key={path}
                href={path}
                className={`capitalize scrn-750:text-xs scrn-1000:text-base text-white hover:text-[#c62931] transition-colors duration-200 relative ${(path === "/" ? pathname === "/" : pathname.startsWith(path))
                  ? "text-red-800"
                  : ""
                  }`}
              >
