        ...
        <div className='flex items-center sm:hidden'>
          <Link href="/">
            <Image
              ...
              width={116}
              height={106}
              className='w-auto h-24 xl:h-28 2xl:h-32'
            />
          </Link>
        </div>
            ...
            label === "SERVICES" ? (
              ...
              >
                <div className="relative flex items-center gap-1">
                  <Link
                    href={path}
                    className={`capitalize md:text-xs lg:text-base text-white hover:text-[#c62931] transition-colors duration-200 relative flex items-center gap-1 ${pathname.startsWith(path) ? "text-red-800" : ""
                      }`}
                  >
                    {label}
                    <ChevronDown
                      className={`w-6 h-6 transition-transform duration-200 ${showDropdown
                          ...
                          : "text-white group-hover:text-[#c62931]"
                        }`}
                    />
                  </Link>
              ...
              <Link
                key={path}
                href={path}
                className={`capitalize md:text-xs lg:text-base text-white hover:text-[#c62931] transition-colors duration-200 relative ${(path === "/" ? pathname === "/" : pathname.startsWith(path))
                  ? "text-red-800"
                  : ""
                  }`}
              >
