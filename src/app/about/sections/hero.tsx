...
const Hero: React.FC = () => {
  ...
  return (
    <div id="hero-section"
      ...
      <div className='absolute inset-0 z-10 hidden scrn-600:block scrn-600:mt-28 scrn-650:mt-24 scrn-800:mt-4 scrn-1100:mt-0 scrn-1900:scale-y-110 scrn-1900:mt-12'>
        <Image
      ...
      <div className='absolute inset-0 z-10 scrn-600:hidden mt-12 scrn-350:mt-0'>
        <Image
      ...
      `}>
        ...
        <div>
          <div className='scrn-750:space-y-0 scrn-800:-space-y-4 scrn-900:-space-y-6 scrn-1000:-space-y-4 scrn-1250:-space-y-6 scrn-1500:-space-y-8 scrn-1700:-space-y-8 scrn-1900:-space-y-12'>
            ...
            <p className='font-regular italic whitespace-nowrap text-5xl scrn-500:text-7xl scrn-750:text-7xl scrn-800:text-7xl scrn-900:text-8xl scrn-1000:text-8xl scrn-1250:text-9xl scrn-1500:text-10xl scrn-1700:text-10xl scrn-1900:text-11xl scrn-2550:text-13xl'>
              US
            </p>
          </div>
        </div>
