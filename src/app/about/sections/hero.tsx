...
const Hero: React.FC = () => {
  return (
    <div id="hero-section" className="scrn-mobile:h-136 sm:h-120 md:h-116 scrn-800:h-120 scrn-900:h-124 lg:h-132 scrn-1100:h-160 xl:h-176 scrn-1500:h-198 scrn-1700:h-224 scrn-1900:h-240 scrn-2k:h-352 sm:justify-center justify-between overflow-hidden">
      {/* Background Image */}
