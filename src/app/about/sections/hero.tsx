...
const Hero: React.FC = () => {
  return (
    <div id="hero-section" className="relative items-center justify-between bg-transparent overflow-hidden 2k:min-h-screen">
      ...
      {/* Left Text Section */}
      <div className="relative z-0 xl:-space-y-6 mac-14:-space-y-8 mac-16:-space-y-16 2xl:-space-y-16 2k:-space-y-8 text-center md:text-left p-12 lg:my-16 xl:my-24 mac-14:my-40 mac-16:my-40 2xl:my-44 2k:my-40">
        {/* Breadcrumb */}
        <nav className="pt-14">
        ...
        <div className='lg:-space-y-4 xl:-space-y-12 mac-14:-space-y-20 mac-16:-space-y-20 2xl:-space-y-28 2k:-space-y-36'>
          ...
          <p className="lg:text-8xl xl:text-8xl mac-14:text-9xl 2xl:text-10xl 2k:text-12xl font-regular italic whitespace-nowrap">
            US
          </p>
        </div>
      </div>
