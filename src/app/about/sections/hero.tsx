  ...
  return (
    <div id="hero-section" className="relative items-center justify-between bg-transparent overflow-hidden 2k:min-h-screen">
      ...
      <div className="relative z-0 -space-y-8 text-center md:text-left p-12 my-40">
        ...
        <div className='mac-14:-space-y-20 2xl:-space-y-36 2k:-space-y-48'>
          <p className="mac-14:text-11xl mac-16:text-13xl 2xl:text-14xl 2k:text-18xl scale-y-110 text-red-600 p-0 m-0 font-semibold whitespace-nowrap">
            ABOUT
          </p>
          <p className="mac-14:text-9xl 2xl:text-10xl 2k:text-12xl font-regular italic whitespace-nowrap">
            US
          </p>
        </div>
      </div>
