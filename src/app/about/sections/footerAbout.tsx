...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 pt-28 scrn-mobile:pt-16 sm:pt-12 md:pt-12 scrn-900:pt-12 xl:pt-24 scrn-1500:pt-40 scrn-1700:pt-52 scrn-1700:px-20 scrn-1900:pt-16 scrn-1900:px-24 scrn-2k:pt-48 scrn-2k:px-32">
