...
const HorizontalScrollSection: React.FC = () => {
  ...
  const sections = [
    ...
    {
      content: (
        <div className="flex flex-col mx-auto items-center lg:mt-10 xl:mt-12 mac-14:mt-16 scrn-1900:mt-20 text-center w-full xl:h-192 scrn-1500:h-208 scrn-1700:h-256 scrn-1900:h-240 scrn-2k:h-352 overflow-hidden">
          <span className="lg:text-5xl xl:text-7xl mac-14:text-7xl scrn-1900:text-7xl scrn-2k:text-9xl italic">Our</span>
          <motion.span
            ref={valuesRef}
