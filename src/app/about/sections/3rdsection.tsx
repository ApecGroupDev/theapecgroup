          ...
          <div className="w-auto flex flex-col flex-1">
            ...
            <div className="xl:-space-y-8 xl:mt-14 scrn-1500:space-y-8 scrn-1500:-mt-0 scrn-1700:-space-y-10 scrn-1900:space-y-12 scrn-2k:mt-32">
              ...
              <div className="flex items-center justify-end">
                <span className="md:text-5xl scrn-800:text-5xl scrn-900:text-5xl lg:text-5xl xl:text-5xl scrn-1500:text-6xl scrn-1700:text-8xl scrn-1900:text-8xl scrn-2k:text-10xl font-semibold">
                  APEC
                </span>
                <span className="md:text-3xl scrn-800:text-3xl scrn-900:text-3xl lg:text-3xl xl:text-3xl scrn-1500:text-3xl scrn-1700:text-5xl scrn-1900:text-5xl scrn-2k:text-7xl font-extralight tracking-widest">
                  will always
                </span>
              </div>
              ...
              <div className="flex justify-end items-start">
                <span className="md:text-8xl scrn-800:text-9xl scrn-900:text-9xl lg:text-9xl xl:text-10xl scrn-1500:text-10xl scrn-1700:text-12xl scrn-1900:text-12xl scrn-2k:text-13xl font-semibold italic xl:mt-12 scrn-1500:-mt-10 scrn-1900:-mt-16 scrn-1900:me-6 scrn-2k:me-10">
                  OUT
                </span>
              </div>
            </div>
