...
const ChooseUs: React.FC = () => {
  ...
  return (
    <section className='flex flex-col items-center text-center overflow-y-visible scrn-750:overflow-hidden py-20 px-10 scrn-1700:pt-40 scrn-2100:pt-48 h-160 scrn-450:h-196 scrn-600:h-148 scrn-700:h-148 scrn-800:h-152 scrn-900:h-164 scrn-1000:h-188 scrn-1100:h-195 scrn-1200:h-208 scrn-1300:h-224 scrn-1400:h-232 scrn-1500:h-256 scrn-1550:h-260 scrn-1600:h-264 scrn-1650:h-268 scrn-1700:h-276 scrn-1850:h-288 scrn-1900:h-296 scrn-2050:h-308 scrn-2150:h-316 scrn-2200:h-324 scrn-2250:h-339 scrn-2300:h-352 scrn-2450:h-368 scrn-2500:h-416'>
      ...
      {/* Content */}
      <p className='font-normal leading-relaxed tracking-wider mt-3 scrn-450:mt-6 scrn-600:mt-6 scrn-750:mt-4 scrn-800:mt-6 scrn-900:mt-8 scrn-1000:mt-10 scrn-1500:mt-12 scrn-1900:mt-12 scrn-400:max-w-96 scrn-600:max-w-md scrn-800:max-w-lg scrn-900:max-w-2xl scrn-1300:max-w-3xl scrn-1500:max-w-4xl text-xs scrn-400:text-sm scrn-900:text-base scrn-1000:text-lg scrn-1300:text-2xl scrn-1900:text-3xl scrn-2500:text-4xl'>
      ...
      <p className='font-normal leading-relaxed tracking-wider scrn-300:mt-2 scrn-450:mt-4 scrn-600:mt-6 scrn-750:mt-4 scrn-1000:mt-8 scrn-400:max-w-80 scrn-600:max-w-sm scrn-800:max-w-md scrn-900:max-w-lg scrn-1300:max-w-xl scrn-1500:max-w-2xl text-xs scrn-400:text-sm scrn-900:text-base scrn-1000:text-lg scrn-1300:text-2xl scrn-1900:text-3xl scrn-2500:text-4xl'
      >
      ...
      <p className='font-normal leading-relaxed text-xs scrn-400:text-sm scrn-900:text-base scrn-1000:text-lg scrn-1300:text-2xl scrn-1500:text-2xl scrn-1900:text-3xl scrn-2500:text-4xl scrn-400:max-w-64 scrn-800:max-w-xs scrn-900:max-w-md scrn-1300:max-w-lg scrn-1500:max-w-xl scrn-300:mt-2 scrn-450:mt-4 scrn-600:mt-6 scrn-750:mt-4 scrn-800:mt-4 scrn-900:mt-4 scrn-1000:mt-6 scrn-1500:mt-8 scrn-1900:mt-8'>
      ...
      <a
        ...
        className='px-16 font-regular py-1 border-2 rounded-lg hover:bg-red-500 border-[#c62931] text-gray-800  hover:text-white transition duration-200 mt-4 scrn-900:mt-4 scrn-600:mt-6 scrn-1500:mt-16 scrn-300:px-8 scrn-750:px-12 scrn-1000:px-20 scrn-2500:px-28 text-xs scrn-750:text-sm scrn-1000:text-lg scrn-1700:text-2xl scrn-1900:text-2xl scrn-2500:text-3xl'>
