...
const ChooseUs: React.FC = () => {
  ...
  return (
    <section className="py-20 px-10 flex flex-col items-center text-center scrn-1700:h-256 scrn-1900:h-240 scrn-2k:h-352 overflow-hidden">
      {/* Heading */}
      <span className="lg:text-6xl xl:text-8xl mac-14:text-8xl scrn-1700:mt-14 scrn-1900:text-8xl scrn-2k:text-9xl font-bold">
        Why
        <motion.p
      ...
      {/* Content */}
      <p className="lg:text-xl lg:max-w-2xl xl:max-w-4xl mac-14:max-w-6xl scrn-1700:max-w-6xl scrn-1900:max-w-6xl xl:text-2xl mac-14:text-2xl scrn-1900:text-3xl scrn-2k:text-4xl leading-normal font-normal scrn-2k:leading-relaxed tracking-wider lg:mt-10 xl:mt-12 mac-14:mt-12 scrn-1900:mt-12">
      ...
      <p className="lg:text-xl lg:max-w-xl xl:max-w-3xl mac-14:max-w-4xl scrn-1700:max-w-4xl scrn-1900:max-w-4xl xl:text-2xl mac-14:text-2xl scrn-1900:text-3xl scrn-2k:text-4xl leading-normal font-normal scrn-2k:leading-relaxed tracking-wider lg:mt-8 xl:mt-6 mac-14:mt-8 scrn-1900:mt-8">
