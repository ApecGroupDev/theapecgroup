...
const ChooseUs: React.FC = () => {
  ...
  return (
    <section className="py-20 px-10 flex flex-col items-center justify-center text-center outline-dashed scrn-1500:h-256 scrn-1700:h-288 scrn-1900:h-240 scrn-2k:h-352 overflow-hidden">
      {/* Heading */}
