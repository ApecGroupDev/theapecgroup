  ...
  return (
    <div className='px-4 sm:px-12 md:px-20 max-w-7xl mx-auto mb-20'>
      ...
      <div className='text-3xl lg:text-5xl 2xl:text-7xl font-bold mb-4'>
        <h1>
          <span className='text-[#c62931]'>Petroleum Research Industry: </span>
          <span className='text-black font-semibold'>What are they studying?</span>
        </h1>
      </div>
      ...
      <div className='lg:ps-12 pt-12'>
        ...
        />
        <p className='text-gray-800 lg:text-lg whitespace-pre-line mt-4'>
          There are various types of <span className='text-[#c62931]'>petroleum research</span>. Some of them are given below:
        </p>
        <p className='text-3xl lg:text-4xl whitespace-pre-line mt-6'>
        ...
        <ul className='list-disc list-inside space-y-2 mt-3 text-lg lg:text-xl'>
          <li>Hydraulic fracturing</li>
          <li>Gas hydrates drilling</li>
          <li>Reservoir Simulation</li>
          <li>Producing gas condensate</li>
          <li>CO2 sequestration</li>
          <li>Multilateral drilling and many other projects</li>
        </ul>
        ...
        <ul className='list-disc text-lg lg:text-xl list-inside space-y-2 mt-3'>
          <li>Enhanced Oil Recovery</li>
          <li>Sustainable energy systems</li>
          <li>Reservoir modelling and others</li>
        </ul>
        <p className='text-3xl lg:text-4xl whitespace-pre-line mt-6'>
          Stanford University
        </p>
        ...
        <ul className='list-disc list-inside space-y-2 mt-3 text-lg lg:text-xl'>
          ...
          <li>Enhanced Oil Recovery</li>
          <li>Carbon capture technologies and many others</li>
        </ul>
        <p className='text-3xl lg:text-4xl whitespace-pre-line mt-6'>
        ...
        <ul className='list-disc list-inside space-y-2 mt-3 text-lg lg:text-xl'>
          ...
          <li>Reservoir Engineering</li>
          <li>Multiphase flow and many others</li>
        </ul>
        ...
        <p className='text-[#c62931] lg:text-lg whitespace-pre-line mt-6'>
