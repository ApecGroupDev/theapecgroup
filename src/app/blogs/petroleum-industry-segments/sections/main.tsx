    ...
    <div className='px-4 sm:px-12 md:px-20 max-w-7xl mx-auto mb-20'>
      ...
      <div className='lg:ps-12 pt-12'>
        ...
        <div className='space-y-3'>
          ...
          <ul className='list-disc list-inside space-y-2 font-semibold text-lg lg:text-xl'>
            <li>Upstream - <span className='font-normal'>exploration and production</span></li>
            <li>Midstream - <span className='font-normal'>transportation and storage</span></li>
            <li>Downstream - <span className='font-normal'>refining and processing</span></li>
          </ul>
        </div>
