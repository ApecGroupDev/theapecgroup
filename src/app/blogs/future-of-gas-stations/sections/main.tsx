  ...
  return (
    <div className='px-4 scrn-600:px-12 scrn-800:px-20 max-w-7xl mx-auto mb-20'>
      ...
      <div className='text-3xl scrn-1000:text-5xl scrn-1900:text-7xl font-bold mb-4'>
        <h1 className='text-[#c62931]'>The Future of Gas Stations: </h1>
        <h1 className='text-black font-semibold'>Innovations Shaping the Petroleum Industry</h1>
      </div>
      ...
      <div className='scrn-1000:ps-12 pt-12'>
        ...
        <p className='text-[#c62931] scrn-1000:text-lg italic font-medium whitespace-pre-line mt-6'>
