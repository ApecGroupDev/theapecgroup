  ...
  return (
    <div className='px-4 scrn-600:px-12 scrn-800:px-20 max-w-7xl mx-auto mb-20'>
      ...
      <div className='text-3xl scrn-1000:text-5xl scrn-1900:text-7xl font-bold mb-4'>
        <h1>
          <span className='text-[#c62931]'>Innovations in Petroleum Equipment: </span>
          <span className='text-black font-semibold'>How Leading Companies Are Shaping the Future</span>
        </h1>
      </div>
      ...
      <div className='scrn-1000:ps-12 pt-12'>
        ...
        <p className='text-gray-800 scrn-1000:text-lg whitespace-pre-line'>
          In an industry known for its rich history and longstanding practices, the petroleum sector is undergoing a transformative
          shift driven by cutting-edge innovations. As global energy demands evolve and environmental concerns take center stage,
          leading companies are reimagining petroleum equipment to enhance efficiency, safety, and sustainability. Here’s a look at
          some of the groundbreaking advancements shaping the future of <span className='text-[#c62931]'>petroleum equipment</span>.
        </p>
        {/* END -INTRO */}
        ...
        <p className='text-gray-800 scrn-1000:text-lg whitespace-pre-line mt-3'>
          Companies like <span className='text-[#c62931]'>The APEC Group</span> is at the forefront of developing autonomous systems that can operate in hazardous environments, reducing the risk to human workers. Automated equipment also contributes to more consistent and reliable operations, minimizing human error and maximizing productivity.
        </p>
        {/* END - GROUP 2 */}
        ...
        <p className='ext-gray-800 scrn-1000:text-lg whitespace-pre-line mt-3'>
