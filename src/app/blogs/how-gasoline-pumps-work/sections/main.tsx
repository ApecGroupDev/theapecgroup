    ...
    <div className='px-4 sm:px-12 md:px-20 max-w-7xl mx-auto mb-20'>
      ...
      <div className='lg:ps-12 pt-12'>
        ...
        <div className='space-y-3'>
          <p className='text-4xl lg:text-5xl font-semibold text-[#c62931] whitespace-pre-line mt-10'>
          ...
          <ul className='list-disc list-inside'>
            <li className='font-semibold text-lg lg:text-xl'>Electronic head:</li>
          </ul>
          ...
          <ul className='list-disc list-inside'>
            <li className='font-semibold text-lg lg:text-xl'>Mechanical section:</li>
          </ul>
        ...
        <div className='space-y-3'>
          ...
          <p className='text-gray-800 text-xl lg:text-2xl whitespace-pre-line'>
            There are some primary types of gasoline pumps, each of which is described below:
          </p>

          <ol className='text-lg lg:text-xl list-decimal list-inside space-y-2'>
            <li>Mechanical Fuel Pump.</li>
            <li>Electrical Fuel Pump.</li>
            <li>Fuel Pump with Diaphragm.</li>
            <li>Fuel Pump with a Plunger.</li>
        ...
        <div className='space-y-3'>
          ...
          <p className='font-semibold text-gray-800 text-xl lg:text-2xl whitespace-pre-line'>
            Centrifugal Pump
          </p>
        ...
        <div className='space-y-3'>
          ...
          <p className='text-2xl lg:text-3xl whitespace-pre-line mt-3 text-[#c62931]'>
            Most gasoline stations use one of two kinds of pumps to get the gas from the storage tanks into the dispenser:
          </p>

          <p className='text-lg lg:text-xl font-semibold whitespace-pre-line mt-6'>
            1.  Submersible Pump
          </p>
          <p className='text-gray-800 lg:text-lg whitespace-pre-line'>
        ...
        <div>
          ...
          <p className='text-gray-800 lg:text-lg whitespace-pre-line mt-6'>
