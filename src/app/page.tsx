...
const Home: React.FC = () => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='md:mt-8 xl:mt-12 mac-16:mt-20 2xl:mt-24'>
        <FeatureBoxes />
      </div>

      <div className='md:mt-40 md:mb-28 w-800:mt-48 w-900:mb-48 lg:mt-60 lg:mb-40 xl:mb-52 mac-14:mt-72 mac-16:mt-80 2xl:mt-96' >
