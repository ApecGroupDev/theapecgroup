...
const FeatureBoxes: React.FC = () => {
  ...
  return (
    <div className="bg-transparent scrn-mobile:px-3 sm:px-20 scrn-mobile:h-132 sm:h-140 md:px-24 md:h-128 scrn-800:px-28 scrn-800:h-132 scrn-900:px-36 scrn-900:h-144 lg:-top-4 lg:px-28 lg:h-176 xl:px-40 xl:h-198 scrn-1500:px-52 scrn-1500:h-256 scrn-1700:px-48 scrn-1700:h-288 scrn-1900:px-40 scrn-1900:h-304 scrn-2k:px-72 scrn-2k:h-416">
      {/* Section Title */}
      <div className="text-center">
        <motion.p
          ref={ref} // Set the ref to the element
          className="text-5xl md:text-5xl scrn-900:text-5xl lg:text-5xl xl:text-6xl scrn-1500:text-7xl scrn-1700:text-7xl scrn-1900:text-8xl scrn-2k:text-9xl font-extrabold text-gray-800"
        ...
        <p className="hidden scrn-mobile:block text-5xl md:text-5xl scrn-900:text-5xl lg:text-5xl xl:text-6xl scrn-1500:text-7xl scrn-1700:text-7xl scrn-1900:text-8xl scrn-2k:text-9xl font-extrabold text-gray-800 mb-4">
          <span className="text-white"> APEC?</span>
        </p>
      </div>

      {/* Feature Boxes */}
      <div className="grid grid-cols-3 scrn-mobile:gap-y-2 sm:gap-y-6 md:gap-y-8 scrn-800:gap-y-6 scrn-900:gap-y-6 lg:gap-y-10 xl:gap-y-12 scrn-1500:gap-y-14 scrn-1700:mt-12 scrn-1700:gap-y-20 scrn-1900:mt-12 scrn-1900:gap-y-24 scrn-2k:gap-y-28">
        {/* First Row: 3 Boxes */}
        {features.slice(0, 3).map((feature, index) => (
          <div
            key={index}
            className="relative mx-auto group bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-xl hover:bg-white transition-all scrn-mobile:w-32 sm:w-36 md:w-36 scrn-800:w-40 scrn-900:w-44 lg:w-52 xl:w-64 scrn-1500:w-72 scrn-1700:w-108 scrn-1900:w-116 scrn-2k:w-128 duration-500"
          >
            <div className="flex flex-col items-center justify-center scrn-mobile:h-20 sm:h-24 md:h-20 scrn-800:h-24 scrn-900:h-28 lg:h-32 xl:h-44 scrn-1500:h-56 scrn-1700:h-64 scrn-1900:h-72 scrn-2k:h-96">
              {feature.icon}
        ...
        <div className="flex flex-wrap justify-center col-span-3 gap-6 scrn-mobile:gap-2 md:gap-12 scrn-800:gap-8 scrn-900:gap-8 scrn-1500:gap-20 scrn-1700:gap-24 scrn-1900:gap-28 scrn-2k:gap-36">
          {features.slice(3).map((feature, index) => (
            <div
              key={index}
              className="relative group bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-xl hover:bg-white transition-all duration-500 scrn-mobile:w-32 sm:w-36 md:w-36 scrn-800:w-40 scrn-900:w-44 lg:w-52 xl:w-64 scrn-1500:w-72 scrn-1700:w-108 scrn-1900:w-116 scrn-2k:w-128"
            >
              <div className="flex flex-col items-center justify-center scrn-mobile:h-20 sm:h-24 md:h-20 scrn-800:h-24 scrn-900:h-28 lg:h-32 xl:h-44 scrn-1500:h-56 scrn-1700:h-64 scrn-1900:h-72 scrn-2k:h-96">
                {feature.icon}
