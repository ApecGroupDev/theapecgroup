...
const FeatureBoxes: React.FC = () => {
  ...
  return (
    <div className="bg-transparent md:px-12 w-900:px-20 scrn-1900:px-40 scrn-1900:h-304 scrn-2k:h-384">
      ...
      {/* Feature Boxes */}
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 mac-16:mt-12 scrn-1900:mt-12 scrn-1900:gap-y-24">
        {/* First Row: 3 Boxes */}
        {features.slice(0, 3).map((feature, index) => (
          <div
            key={index}
            className="relative mx-auto group bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-xl hover:bg-white transition-all md:w-10/12 lg:w-11/12 xl:w-10/12 mac-14:w-11/12 scrn-1900:w-116 scrn-2k:w-10/12 duration-500"
          >
        ...
        <div className="flex flex-wrap justify-center col-span-1 md:col-span-3 gap-8 md:gap-14 mac-14:gap-32 mac-16:gap-24 scrn-1900:gap-28 scrn-2k:mt-12">
          {features.slice(3).map((feature, index) => (
            <div
              key={index}
              className="relative group bg-gray-100 p-6 rounded-lg shadow-lg hover:shadow-xl hover:bg-white transition-all duration-500 w-3/5 md:w-1/4 lg:w-3/12 scrn-1900:w-116"
            >
