...
const MembershipLogosCarousel: React.FC = () => {
  ...
  return (
    <div className="bg-transparent px-12 md:px-36 scrn-2k:px-40 outline-dashed xl:h-184 scrn-1500:h-208 scrn-1700:h-224 scrn-1900:h-288 scrn-2k:h-384">
            ...
            <SwiperSlide key={index}>
              <div className="mt-12 md:mt-0 flex flex-col items-center p-4 transition-transform duration-300 ease-in-out hover:scale-110">
                <Image
                  ...
                  width={800}
                  height={800}
                  className="h-44 md:h-40 xl:h-60 lg:h-48 scrn-1500:h-64 scrn-1700:h-80 scrn-1900:h-80 scrn-2k:h-96 max-w-full object-contain mb-4"
                />
              </div>
            </SwiperSlide>
          ))}
