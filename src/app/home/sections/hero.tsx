...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between bg-transparent md:px-12 scrn-800:h-120 scrn-900:h-124 lg:h-144 xl:h-160 scrn-1500:h-198 scrn-1700:h-224 scrn-1900:h-240 scrn-2k:h-320">
      {/* Left Text Section */}
