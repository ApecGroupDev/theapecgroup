        ...
        <div className='items-start gap-1 scrn-1500:ms-16 scrn-2300:ms-8 -space-y-1.5 text-center mb-6 scrn-400:mb-0 scrn-600:text-left scrn-1000:pb-5 z-20 hidden scrn-600:flex'>
          ...
          <div className="text-[#c62931] my-auto scale-50 scrn-800:scale-75 scrn-1000:scale-100 -ms-8 scrn-800:-ms-2 scrn-1000:ms-2">
            ...
            <div className="grid grid-cols-1 gap-4 scrn-1000:gap-2 scrn-1300:gap-6 scrn-1000:ms-4">
              <Image src="/logos/Auth_Dis/Auth_Dis_Dover.png" alt="Dover" width={180} height={60} className='scrn-1200:scale-90' />
              <Image src="/logos/Auth_Dis/Auth_Dis_Wayne.png" alt="Wayne" width={180} height={60} className='scrn-1200:scale-90' />
              <Image src="/logos/Auth_Dis/Auth_Dis_Verifone.png" alt="Verifone" width={180} height={60} className='scrn-1200:scale-90' />
              <Image src="/logos/Auth_Dis/Auth_Dis_OPW.png" alt="OPW" width={180} height={60} className='scrn-1200:scale-90' />
              <Image src="/logos/Auth_Dis/Auth_Dis_Franklin.png" alt="Franklin" width={180} height={60} className='scrn-1200:scale-90' />
            </div>
          </div>
