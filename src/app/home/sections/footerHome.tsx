...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 pt-32 md:pt-4 scrn-900:pt-12 xl:pt-24 scrn-1500:pt-40 scrn-1700:pt-52 scrn-1700:px-20 scrn-1900:pt-32 scrn-1900:px-24 scrn-2k:px-32">
        ...
        <div className="flex justify-center md:justify-end">
          <Link href="/">
            <Image
              ...
              height={1206}
              width={1315}
              className="transition-transform duration-300 ease-in-out transform hover:scale-105 h-28 md:h-28 lg:h-40 xl:h-52 scrn-1500:h-60 scrn-1700:h-72 scrn-1900:h-72 scrn-2k:h-80 w-auto"
            />
          </Link>
        </div>
      </div>
