...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 pt-32 md:pt-4 lg:pt-6 xl:pt-24 scrn-1500:pt-40 scrn-1700:pt-52 scrn-1700:px-20 scrn-1900:pt-32 scrn-1900:px-24 scrn-2k:px-32">
