...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 pt-32 sm:pt-12 md:pt-4 scrn-900:pt-12 xl:pt-24 scrn-1500:pt-40 scrn-1700:pt-52 scrn-1700:px-20 scrn-1900:pt-32 scrn-1900:px-24 scrn-2k:px-32">
      <div className="grid sm:grid-cols-3 gap-8 items-center text-gray-300">
        {/* Column 1: Social Media Icons */}
        <div className="flex flex-col items-center sm:ms-4 md:ms-0 sm:items-start space-y-2 md:space-y-1 lg:space-y-2">
          <span className="md:text-xs md:pt-6 xl:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg footer-text-dark">For More Information</span>
          <span className='md:ps-0 lg:ps-6 md:text-xs xl:text-sm scrn-1500:text-base scrn-1700:text-lg scrn-1900:text-lg whitespace-nowrap footer-text-dark'>855-444-APEC | Sales@TheAPECgroup.com</span>
          <div className="sm:hidden md:flex space-x-4 md:ps-0 lg:ps-12">
            <SocialIcon
          ...
          <div className="sm:flex md:hidden space-x-4">
            <SocialIcon
              url="https://twitter.com"
              target="_blank"
        ...
        <div className="flex justify-center md:justify-end">
          <Link href="/">
            <Image
              ...
              height={1206}
              width={1315}
              className="transition-transform duration-300 ease-in-out transform hover:scale-105 h-32 md:h-28 lg:h-40 xl:h-52 scrn-1500:h-60 scrn-1700:h-72 scrn-1900:h-72 scrn-2k:h-80 w-auto"
            />
          </Link>
        </div>
      </div>
