...
const About: React.FC = () => {
  ...
  return (
    <div className='w-full bg-transparent flex flex-col scrn-750:flex-row px-12 scrn-300:px-8 scrn-1500:-mt-8 h-140 scrn-400:h-148 scrn-600:h-148 scrn-750:h-128 scrn-800:h-132 scrn-900:h-148 scrn-1000:h-176 scrn-1100:h-176 scrn-1150:h-176 scrn-1200:h-184 scrn-1300:h-192 scrn-1400:h-208 scrn-1500:h-240 scrn-1600:h-248 scrn-1700:h-272 scrn-1800:h-276 scrn-1900:h-304 scrn-2000:h-304 scrn-2100:h-320 scrn-2200:h-339 scrn-2300:h-352 scrn-2400:h-360 scrn-2450:h-368 scrn-2500:h-368'>
      {/* Left Image Section */}
      <div className='w-full hidden scrn-750:block scrn-750:w-2/5 scrn-1200:w-1/2'>
        <Image
          src="/products/stationUpdated_new.png"
          alt="Hero"
          width={3264}
          height={4601}
      ...
      {/* Right Text Section */}
      <div className='text-center scrn-300:mt-8 scrn-400:mt-0 scrn-750:text-left scrn-400:px-12 scrn-450:px-8 scrn-750:w-3/5 scrn-1000:w-1/2 scrn-1200:mt-12 scrn-1300:mt-6 flex flex-col scrn-1000:mx-auto scrn-1500:px-10 scrn-1500:mt-20 scrn-1700:pe-20 scrn-1700:mt-20 scrn-1900:pe-20 scrn-1900:mt-24 scrn-2000:pe-32 scrn-2000:mt-36 scrn-2300:pe-60'>
