  ...
  return (
    <div className="w-full bg-transparent flex flex-col md:flex-row px-12 outline-dashed scrn-2k:h-320">
      ...
      <div className="text-center md:text-left md:w-3/5 lg:w-1/2 xl:mt-16 flex flex-col lg:mx-auto mac-14:px-10 mac-14:mt-20 mac-16:pe-20 mac-16:mt-20 2xl:pe-20 2xl:mt-24 2k:pe-32 2k:mt-36">
        ...
        <p className="text-2xl md:text-xl lg:text-2xl mac-14:text-3xl mac-16:text-3xl 2xl:text-4xl 2k:text-5xl font-medium text-gray-800">
          Petroleum Equipment Services
        </p>
        <p className="mt-4 2xl:mt-12 text-justify md:text-sm w-900:text-base lg:text-base xl:text-lg mac-14:text-xl mac-16:text-2xl 2xl:text-2xl 2xl:tracking-widest 2k:text-3xl text-gray-800">
        ...
        <p className="mt-4 md:text-sm text-justify w-900:text-base lg:text-base xl:text-lg mac-14:text-xl mac-16:text-2xl 2xl:text-2xl 2xl:tracking-widest 2k:text-3xl text-gray-800">
        ...
        {/* Button */}
        <div className="mt-8 md:mt-4 2xl:mt-12 2k:mt-20 flex justify-center">
          <button
            className="px-16 md:px-12 md:text-sm lg:px-20 2k:px-28 py-1 border-2 border-red-600 text-gray-800 lg:text-lg mac-16:text-2xl 2xl:text-2xl 2k:text-3xl font-regular rounded-lg hover:bg-red-600 hover:text-white transition duration-200"
          >
