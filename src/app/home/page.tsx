...
const Home: React.FC = () => {
  return (
    <div className='flex flex-col'>
      ...
      <div className='mt-40 md:mt-40 md:mb-28 w-800:mt-48 w-900:mt-56 w-900:mb-36 lg:mt-60 lg:mb-40 xl:mt-72 xl:mb-40 mac-14:mt-72 mac-16:mt-96 2xl:mt-96 2k:mt-128 2k:mb-80' >
