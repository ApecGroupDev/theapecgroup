...
const Hero: React.FC = () => {
  ...
  return (
    <div
      id="hero-section"
      ref={heroRef}
      className='relative flex items-center overflow-hidden h-116 scrn-350:h-120 scrn-400:h-124 scrn-450:h-136 scrn-500:h-148 scrn-600:h-108 scrn-650:h-110 scrn-700:h-112 scrn-750:h-116 scrn-800:h-120 scrn-850:h-124 scrn-900:h-128 scrn-950:h-132 scrn-1000:h-140 scrn-1100:h-156 scrn-1200:h-164 scrn-1250:h-172 scrn-1300:h-176 scrn-1350:h-180 scrn-1400:h-188 scrn-1450:h-192 scrn-1500:h-198 scrn-1550:h-208 scrn-1600:h-216 scrn-1650:h-224 scrn-1700:h-228 scrn-1750:h-232 scrn-1800:h-240 scrn-1850:h-244 scrn-1900:h-264 scrn-1950:h-272 scrn-2000:h-280 scrn-2050:h-288 scrn-2100:h-296 scrn-2150:h-304 scrn-2200:h-312 scrn-2250:h-316 scrn-2300:h-324 scrn-2400:h-339 scrn-2500:h-352'>
      {/* Left Text Section */}
