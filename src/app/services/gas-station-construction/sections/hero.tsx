...
const Hero: React.FC = () => {
  ...
  return (
    <div
      id="hero-section"
      className='
      bg-[url("/backgrounds/services/construction/Hero.webp")] bg-cover bg-top bg-no-repeat bg-blend-multiply bg-black/40
      ...
      <div>
        ...
        <div className='text-gray-200 font-normal ps-8 pe-4 scrn-750:pe-0 pt-8 scrn-750:w-4/5 scrn-1700:w-1/2'>
          <h1 className='text-2xl scrn-750:text-2xl scrn-1000:text-3xl scrn-1500:text-4xl'>
            Trusted by fuel retailers across Georgia, Texas, and Atlanta for
