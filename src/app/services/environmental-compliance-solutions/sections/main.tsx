      ...
      <div className="mt-12">
        <p className="tracking-wider text-lg">
          ...
          <span className="text-[#c62931] font-semibold">
            custom environmental compliance solutions
          </span>{" "}
          that protect your business from fines, shutdowns, and environmental
          harm. With 30+ years of expertise, we help fuel retailers and
          operators meet or exceed all local, state, and federal requirements.
        </p>
        <p className="tracking-wider text-lg text-[#c62931] italic mt-8">
          Let us handle compliance so you can focus on your business with peace
          of mind.
        </p>
      </div>
      ...
      <div className="mt-12 grid md:grid-cols-2 md:gap-x-6 xl:gap-x-24">
        <div className="h-auto">
          <h2 className="text-4xl font-extrabold text-gray-900">
            Why Choose APEC For{" "}
            <span className="text-[#c62931]">Environmental Compliance?</span>
          </h2>
