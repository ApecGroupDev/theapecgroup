      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div {...fadeUp(0.15)}>
          <p className="text-white/50 text-base leading-relaxed mb-4">
            ...
            attract customers, and help your station stand out. With 35+ years
            of experience, we handle design, production, and installation to
            ensure your canopy looks as good as it performs.
          </p>
