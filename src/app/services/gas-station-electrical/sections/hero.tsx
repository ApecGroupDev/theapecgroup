...
const Hero: React.FC = () => {
  ...
  return (
    <div
      id="hero-section"
      className='
      bg-[url("/backgrounds/services/electrical/Hero_Electrical.webp")] bg-cover bg-top bg-no-repeat bg-blend-multiply bg-black/40
        ...
        <div>
          <h1 className='ps-8 pe-4 scrn-750:pe-0 scrn-750:w-4/5 scrn-1700:w-1/2'>
            <span className='font-bold scrn-750:font-semibold whitespace-normal text-gray-200 text-4xl scrn-750:text-6xl scrn-1000:text-7xl tracking-wide'>
              Gas Station Electrical Contractors That Keep Your Station Safe, Reliable, and Code-Compliant
            </span>
          </h1>
        </div>
