    ...
    <div className="bg-transparent flex flex-col items-center sm:justify-center h-auto max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div className="mt-12">
        ...
        <p className="mt-8 tracking-wider text-lg">
          At <span className="text-[#c62931] font-semibold">APEC</span>, we
          specialize in{" "}
          <span className="text-[#c62931] font-semibold">
            gas station electrical contracting
          </span>
          — delivering{" "}
          <span className="text-[#c62931] font-semibold">
            turnkey installations, upgrades, and maintenance
          </span>{" "}
          designed specifically for fueling environments. With decades of
          expertise, we ensure every project is{" "}
          <span className="text-[#c62931] font-semibold">
            code-compliant, efficient, and built to last.
          </span>
        </p>
        <p className="tracking-wider text-lg text-[#c62931] italic mt-8">
          Let us handle your electrical systems so you can focus on fueling your
          customers — safely and profitably.
        </p>
      </div>
      ...
      <div className="mt-12 grid md:grid-cols-2 md:gap-x-6 xl:gap-x-24">
        <div className="h-auto">
          <h2 className="text-4xl font-extrabold text-gray-900">
            Why Choose APEC For{" "}
            <span className="text-[#c62931]">Gas Station Electrical Work?</span>
          </h2>
        ...
        <div className="relative flex items-center mt-6 sm:mt-8 z-10">
          ...
          >
            <h2 className="text-4xl font-extrabold mb-12">
              <span className="text-[#c62931]">Gas Station Electrical</span>{" "}
              Service Request
            </h2>
