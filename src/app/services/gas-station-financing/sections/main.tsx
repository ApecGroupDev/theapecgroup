      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div {...fadeUp(0.15)}>
          <p className="text-white/50 text-base leading-relaxed mb-4">
            Building or upgrading a gas station takes more than a great plan —
            it takes the right financing to bring it to life.{" "}
            ...
            construction, equipment, and site improvements. With over 30 years
            of experience in the petroleum industry, we understand your business
    ...
    <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24">
      <motion.div {...fadeUp(0)} className="mb-12">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          ...
          >
            Why Choose APEC For{" "}
            <span className="text-[#c62931]">Financing?</span>
          </h2>
          <p className="text-[#111]/40 text-sm max-w-xs leading-relaxed lg:text-right">
            30+ years of petroleum experience, trusted by operators across
            Georgia.
          </p>
        </div>
