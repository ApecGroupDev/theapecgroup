...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 scrn-mobile:pt-24 sm:pt-20 md:pt-4 scrn-800:pt-12 scrn-900:pt-12 xl:pt-24 scrn-1500:pt-28 scrn-1700:pt-36 scrn-1700:px-20 scrn-1900:pt-48 scrn-1900:px-24 scrn-2k:pt-64 scrn-2k:px-32">
