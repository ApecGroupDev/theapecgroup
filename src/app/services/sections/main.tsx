...
const MainServices: React.FC = () => {
  return (
    <div className="bg-transparent outline-dashed outline-green-500 scrn-1900:px-28 scrn-1900:h-352 scrn-2k:h-448">
      ...
      {/* Feature Boxes */}
      <div className="grid grid-cols-3 scrn-1900:gap-y-32">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center scrn-1900:h-80 scrn-2k:h-116">
              <img
                ...
                alt={feature.title}
                className="scrn-1900:w-2/3 object-contain"
              />
            </div>
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-6 opacity-0 translate-y-8 group-hover:translate-y-0 group-hover:opacity-100 bg-white bg-opacity-95 rounded-lg shadow-lg transition-all duration-500 ease-in-out">
              <p className="scrn-1900:text-4xl text-gray-700 text-center overflow-y-auto max-h-48 px-4">
                {feature.description}
              </p>
            </div>
          </div>
