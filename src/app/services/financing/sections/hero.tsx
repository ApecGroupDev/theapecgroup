...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`fixed scrn-300:p-2 scrn-mobile:p-4 scrn-300:space-y-8 scrn-mobile:space-y-16 sm:p-8 md:ms-0 sm:space-y-5 md:space-y-12 scrn-800:space-y-12 scrn-800:tracking-tighter scrn-900:space-y-12 lg:space-y-6 xl:space-y-6 scrn-1500:space-y-28 scrn-1700:space-y-6 scrn-1900:space-y-2 scrn-2k:space-y-8 text-left md:p-12 scrn-1900:ps-24 scrn-300:my-12 scrn-mobile:my-12 scrn-900:my-8 lg:my-16 xl:my-24 scrn-1900:my-48 scrn-2k:my-64 transition-opacity duration-100 ${fadeOut ? 'opacity-0 pointer-events-none' : 'opacity-100'
          }`}
      >
        ...
        <div>
          <span className="scrn-300:text-6xl scrn-mobile:text-6xl sm:text-6xl md:text-6xl scrn-800:text-7xl scrn-900:text-7xl scrn-900:tracking-wide lg:text-8xl lg:tracking-tighter xl:text-9xl xl:tracking-tighter scrn-1500:text-9xl scrn-1500:tracking-normal scrn-1700:text-8xl scrn-1700:tracking-normal scrn-1900:text-8xl scrn-1900:tracking-tighter scrn-2k:text-9xl scrn-2k:tracking-tight scale-y-110 p-0 m-0 font-semibold whitespace-nowrap">
