const FutureOfGasStations = () => {
  return (
    <div className='scrn-1000:ps-12 pt-12'>
      <p className="text-gray-800 scrn-1000:text-xl whitespace-pre-line">
      ...
      <p className="text-xl scrn-1000:text-3xl font-semibold text-[#c62931] whitespace-pre-line mt-6">
      ...
      <p className="text-xl scrn-1000:text-3xl font-semibold text-[#c62931] whitespace-pre-line my-6">
        Stay tuned for more updates on industry trends and innovations in petroleum services!
      </p>

      <p className="text-xl scrn-1000:text-3xl font-semibold text-[#c62931] whitespace-pre-line">
        FAQ
      </p>

      <p className="text-[#c62931] scrn-1000:text-2xl font-medium whitespace-pre-line">
      ...
      <p className="text-[#c62931] scrn-1000:text-2xl font-medium whitespace-pre-line mt-6">
...
export default FutureOfGasStations;
