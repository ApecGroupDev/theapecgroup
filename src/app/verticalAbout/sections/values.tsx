...
const ValuesSection: React.FC = () => {
  ...
  return (
    <div
      className="relative w-full overflow-hidden max-w-[2560px]
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        {/* Background image */}
        <div className="w-full h-full bg-[url('/backgrounds/Values_bg.jpg')] bg-cover bg-center filter blur-sm brightness-75" />

        {/* Top and bottom white gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-white via-transparent to-white" />
      </div>

      {/* Foreground content stays the same */}
      <div className="relative z-10 flex flex-col justify-center h-full text-center px-4">
        ...
        <p className="text-pretty font-medium text-white tracking-widest scrn-300:text-lg scrn-1300:text-2xl scrn-1800:text-4xl scrn-2500:text-4xl mt-4 scrn-1500:mt-16">
