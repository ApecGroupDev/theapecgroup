...
import { blogData, BlogThumbnail } from '../../blogs/components/blogData';
      ...
      {[0, 4].map((startIdx) => (
        <div key={startIdx} className='grid grid-cols-1 px-2 scrn-1000:grid-cols-2 gap-4 max-w-7xl scrn-2100:max-w-8xl'>
          ...
          <div
            ...
            className='relative overflow-hidden rounded-lg scrn-1000:h-full shadow-lg cursor-pointer scrn-500:mx-12 scrn-600:mx-0 h-64 scrn-450:h-72 scrn-500:h-80 scrn-800:h-96 scrn-900:h-118'>
            <img
          ...
          <div className='flex flex-col gap-4'>
            <div className='grid grid-cols-1 scrn-600:grid-cols-2 gap-4 scrn-1000:h-1/2'>
              {[startIdx + 1, startIdx + 2].map((i) => (
                <div
                  ...
                  className='relative overflow-hidden rounded-lg shadow-lg cursor-pointer scrn-500:mx-12 scrn-600:mx-0 h-64 scrn-450:h-72 scrn-500:h-80 scrn-900:h-96 scrn-1000:h-full'>
                  <img
            ...
            <div
              ...
              className='relative scrn-1000:h-1/2 overflow-hidden rounded-lg shadow-lg cursor-pointer scrn-500:mx-12 scrn-600:mx-0 h-64 scrn-450:h-72 scrn-500:h-80 scrn-800:h-96 scrn-900:h-118'>
              <img
        ...
        <div className='fixed inset-0 z-50 bg-white bg-opacity-95 flex flex-col p-8 overflow-y-auto'>
          ...
          <div className='max-w-7xl mx-auto'>
            <img
              ...
              alt="Blog Image"
              className='w-full object-center rounded-lg mb-6 scrn-1900:h-172'
            />
          ...
          <button onClick={closeBlog} className='ml-auto mt-12 text-6xl text-red-700 hover:text-red-500 hover:scale-150'>
            &times;
          </button>
        </div>
      )}
