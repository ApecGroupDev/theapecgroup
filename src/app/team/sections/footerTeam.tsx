...
const Footer: React.FC = () => {
  return (
    <footer className="text-black font-inter md:px-8 md:pt-4 lg:pt-6 xl:pt-24 mac-14:pt-40 mac-16:pt-52 mac-16:px-20 2xl:px-24 scrn-1900:pt-40 scrn-2k:px-32">
        ...
        <div className="flex justify-center md:justify-end scrn-mobile:-mt-16 sm:-mt-16">
          <Link href="/">
            <Image
              ...
              height={1206}
              width={1315}
              className="transition-transform duration-300 ease-in-out transform hover:scale-105 h-20 sm:h-16 md:h-28 lg:h-40 xl:h-52 mac-14:h-60 mac-16:h-72 2xl:h-72 scrn-2k:h-80 w-auto"
            />
          </Link>
        </div>
      </div>
