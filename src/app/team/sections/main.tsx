...
const TeamPage: React.FC = () => {
  ...
  return (
    <section className="outline-dashed outline-green-500 text-center pt-24 scrn-1700:h-448 scrn-1900:h-480 scrn-2k:h-640">
      ...
      <div className="scrn-1700:space-y-8 scrn-1900:space-y-16 scrn-2k:space-y-32 mt-16">
        {rows.map((row, rowIndex) => (
          <div
            key={rowIndex}
            className={`grid scrn-1700:justify-items-center scrn-1700:mx-24 scrn-2k:justify-items-center scrn-2k:mx-24 
              ${row.length === 2 ? 'grid-cols-2 scrn-1700:mx-80 scrn-1900:mx-80 scrn-2k:mx-124' : 'grid-cols-3'
              }`}
          >
            {row.map((member) => (
