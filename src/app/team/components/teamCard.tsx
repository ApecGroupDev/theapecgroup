...
const TeamCard: React.FC<TeamCardProps> = ({ name, title }) => {
  return (
    <div className='relative flex items-center rounded-lg overflow-visible w-36 scrn-300:h-12 scrn-450:w-44 scrn-450:h-16 scrn-600:w-44 scrn-600:h-16 scrn-750:w-56 scrn-750:h-20 scrn-800:w-56 scrn-800:h-20 scrn-900:w-60 scrn-900:h-24 scrn-1000:w-72 scrn-1000:h-28 scrn-1250:w-80 scrn-1250:h-32 scrn-1500:w-112 scrn-1500:h-36 scrn-1700:w-116 scrn-1900:w-116 scrn-1900:h-40 scrn-2500:w-128 scrn-2500:h-48'>
      ...
      <div className='relative bg-gradient-to-r from-[#c62931] to-transparent clip-parallelogram overflow-visible w-16 h-12 scrn-450:w-24 scrn-450:h-16 scrn-600:w-24 scrn-600:h-16 scrn-750:w-28 scrn-750:h-20 scrn-800:w-28 scrn-800:h-20 scrn-900:w-32 scrn-900:h-24 scrn-1000:w-36 scrn-1000:h-28 scrn-1250:w-40 scrn-1250:h-32 scrn-1500:w-44 scrn-1500:h-36 scrn-1900:w-48 scrn-1900:h-40 scrn-2500:w-56 scrn-2500:h-48 scrn-300:ps-0.5 scrn-1000:ps-1'>
        <div className='bg-white clip-parallelogram flex items-center justify-center w-16 h-12 scrn-450:w-24 scrn-450:h-16 scrn-600:w-24 scrn-600:h-16 scrn-750:w-28 scrn-750:h-20 scrn-800:w-28 scrn-800:h-20 scrn-900:w-32 scrn-900:h-24 scrn-1000:w-36 scrn-1000:h-28 scrn-1250:w-40 scrn-1250:h-32 scrn-1500:w-44 scrn-1500:h-36 scrn-1900:w-48 scrn-1900:h-40 scrn-2500:w-56 scrn-2500:h-48'>
          <Image
